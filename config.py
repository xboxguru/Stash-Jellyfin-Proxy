...
def save_config():
    keys_to_save = [
        ...
        "ENABLE_LIVE_TV", "TUNER_M3U_URL", "TUNER_XMLTV_URL"
    ]
...
def _coerce_config_value(key, val):
    ...
    elif key in ["ENABLE_FILTERS", "ENABLE_TAG_FILTERS", "ENABLE_ALL_TAGS", "REQUIRE_AUTH_FOR_CONFIG", "STASH_VERIFY_TLS", "TRUST_PROXY_HEADERS", "UI_PUBLIC_STATUS_ENDPOINT", "UI_CSRF_PROTECTION", "ENABLE_LIVE_TV"]:
