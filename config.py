...
ENABLE_VERTICAL_TV_CHANNEL = False   # always-on Live TV channel that runs the Triptych compositor continuously (Feature 1 Phase 2)
VERTICAL_TV_CHANNEL_NUMBER = 9000    # channel number for the Vertical TV channel
FFMPEG_PATH = "ffmpeg"
...
def save_config():
    keys_to_save = [
        ...
        "ENABLE_VERTICAL_TV_CHANNEL", "VERTICAL_TV_CHANNEL_NUMBER",
